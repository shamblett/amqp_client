...
${OBJECTDIR}/ExtConnection.o: ExtConnection.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExtConnection.o ExtConnection.cpp

${OBJECTDIR}/ExtLocalQueue.o: ExtLocalQueue.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExtLocalQueue.o ExtLocalQueue.cpp

${OBJECTDIR}/ExtMessage.o: ExtMessage.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExtMessage.o ExtMessage.cpp

${OBJECTDIR}/ExtMessageListener.o: ExtMessageListener.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExtMessageListener.o ExtMessageListener.cpp

${OBJECTDIR}/ExtSession.o: ExtSession.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExtSession.o ExtSession.cpp

${OBJECTDIR}/ExtSubscription.o: ExtSubscription.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExtSubscription.o ExtSubscription.cpp

${OBJECTDIR}/ExtSubscriptionManager.o: ExtSubscriptionManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExtSubscriptionManager.o ExtSubscriptionManager.cpp

${OBJECTDIR}/ExtUuid.o: ExtUuid.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExtUuid.o ExtUuid.cpp

${OBJECTDIR}/amqp_extension.o: amqp_extension.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/amqp_extension.o amqp_extension.cpp
